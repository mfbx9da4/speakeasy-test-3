...
/** @internal */
export type LinkGithubAccessResponse$Outbound = {
  HttpMeta: components.HTTPMetadata$Outbound;
};

/** @internal */
export const LinkGithubAccessResponse$outboundSchema: z.ZodType<
  LinkGithubAccessResponse$Outbound,
  z.ZodTypeDef,
  LinkGithubAccessResponse
> = z.object({
 ...
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export namespace LinkGithubAccessResponse$ {
  /** @deprecated use `LinkGithubAccessResponse$inboundSchema` instead. */
  export const inboundSchema = LinkGithubAccessResponse$inboundSchema;
  /** @deprecated use `LinkGithubAccessResponse$outboundSchema` instead. */
  export const outboundSchema = LinkGithubAccessResponse$outboundSchema;
  /** @deprecated use `LinkGithubAccessResponse$Outbound` instead. */
  export type Outbound = LinkGithubAccessResponse$Outbound;
}

export function linkGithubAccessResponseToJSON(
  linkGithubAccessResponse: LinkGithubAccessResponse,
): string {
  return JSON.stringify(
    LinkGithubAccessResponse$outboundSchema.parse(linkGithubAccessResponse),
  );
}
