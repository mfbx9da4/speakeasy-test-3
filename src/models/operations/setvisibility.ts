...
/** @internal */
export type SetVisibilityResponse$Outbound = {
  HttpMeta: components.HTTPMetadata$Outbound;
};

/** @internal */
export const SetVisibilityResponse$outboundSchema: z.ZodType<
  SetVisibilityResponse$Outbound,
  z.ZodTypeDef,
  SetVisibilityResponse
> = z.object({
 ...
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export namespace SetVisibilityResponse$ {
  /** @deprecated use `SetVisibilityResponse$inboundSchema` instead. */
  export const inboundSchema = SetVisibilityResponse$inboundSchema;
  /** @deprecated use `SetVisibilityResponse$outboundSchema` instead. */
  export const outboundSchema = SetVisibilityResponse$outboundSchema;
  /** @deprecated use `SetVisibilityResponse$Outbound` instead. */
  export type Outbound = SetVisibilityResponse$Outbound;
}

export function setVisibilityResponseToJSON(
  setVisibilityResponse: SetVisibilityResponse,
): string {
  return JSON.stringify(
    SetVisibilityResponse$outboundSchema.parse(setVisibilityResponse),
  );
}
