...
> = z
    .object({
        ...
        signedAccess: z.lazy(() => GetLintingReportSignedUrlSignedAccess$inboundSchema).optional(),
    })
    .transform((v) => {
        return remap$(v, {
            HttpMeta: "httpMeta",
...
/** @internal */
export type GetLintingReportSignedUrlResponse$Outbound = {
    HttpMeta: components.HTTPMetadata$Outbound;
    signedAccess?: GetLintingReportSignedUrlSignedAccess$Outbound | undefined;
};

/** @internal */
export const GetLintingReportSignedUrlResponse$outboundSchema: z.ZodType<
    GetLintingReportSignedUrlResponse$Outbound,
    z.ZodTypeDef,
    GetLintingReportSignedUrlResponse
> = z
    .object({
        httpMeta: components.HTTPMetadata$outboundSchema,
        signedAccess: z.lazy(() => GetLintingReportSignedUrlSignedAccess$outboundSchema).optional(),
    })
    .transform((v) => {
        return remap$(v, {
            httpMeta: "HttpMeta",
...
export namespace GetLintingReportSignedUrlResponse$ {
    /** @deprecated use `GetLintingReportSignedUrlResponse$inboundSchema` instead. */
    export const inboundSchema = GetLintingReportSignedUrlResponse$inboundSchema;
    /** @deprecated use `GetLintingReportSignedUrlResponse$outboundSchema` instead. */
    export const outboundSchema = GetLintingReportSignedUrlResponse$outboundSchema;
