...
> = z
    .object({
        ...
        signedAccess: z.lazy(() => GetChangesReportSignedUrlSignedAccess$inboundSchema).optional(),
    })
    .transform((v) => {
        return remap$(v, {
            HttpMeta: "httpMeta",
...
> = z
    .object({
        ...
        signedAccess: z.lazy(() => GetChangesReportSignedUrlSignedAccess$outboundSchema).optional(),
    })
    .transform((v) => {
        return remap$(v, {
            httpMeta: "HttpMeta",
...
export namespace GetChangesReportSignedUrlResponse$ {
    ...
    export const outboundSchema = GetChangesReportSignedUrlResponse$outboundSchema;
