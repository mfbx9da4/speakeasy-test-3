...
/** @internal */
export type ArchiveNamespaceResponse$Outbound = {
  HttpMeta: components.HTTPMetadata$Outbound;
};

/** @internal */
export const ArchiveNamespaceResponse$outboundSchema: z.ZodType<
  ArchiveNamespaceResponse$Outbound,
  z.ZodTypeDef,
  ArchiveNamespaceResponse
> = z.object({
 ...
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export namespace ArchiveNamespaceResponse$ {
  /** @deprecated use `ArchiveNamespaceResponse$inboundSchema` instead. */
  export const inboundSchema = ArchiveNamespaceResponse$inboundSchema;
  /** @deprecated use `ArchiveNamespaceResponse$outboundSchema` instead. */
  export const outboundSchema = ArchiveNamespaceResponse$outboundSchema;
  /** @deprecated use `ArchiveNamespaceResponse$Outbound` instead. */
  export type Outbound = ArchiveNamespaceResponse$Outbound;
}

export function archiveNamespaceResponseToJSON(
  archiveNamespaceResponse: ArchiveNamespaceResponse,
): string {
  return JSON.stringify(
    ArchiveNamespaceResponse$outboundSchema.parse(archiveNamespaceResponse),
  );
}
