...
export namespace GenerateRequestPostmanCollectionRequest$ {
    ...
    export const inboundSchema = GenerateRequestPostmanCollectionRequest$inboundSchema;
    /** @deprecated use `GenerateRequestPostmanCollectionRequest$outboundSchema` instead. */
    export const outboundSchema = GenerateRequestPostmanCollectionRequest$outboundSchema;
...
export namespace GenerateRequestPostmanCollectionResponse$ {
    ...
    export const inboundSchema = GenerateRequestPostmanCollectionResponse$inboundSchema;
    /** @deprecated use `GenerateRequestPostmanCollectionResponse$outboundSchema` instead. */
    export const outboundSchema = GenerateRequestPostmanCollectionResponse$outboundSchema;
