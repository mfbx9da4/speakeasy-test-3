...
export function deleteWorkspaceTokenResponseToJSON(
  deleteWorkspaceTokenResponse: DeleteWorkspaceTokenResponse,
): string {
  return JSON.stringify(
    DeleteWorkspaceTokenResponse$outboundSchema.parse(
      deleteWorkspaceTokenResponse,
    ),
  );
}
