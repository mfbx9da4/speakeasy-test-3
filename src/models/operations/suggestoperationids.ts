...
/** @internal */
export const SuggestOperationIDsResponse$inboundSchema: z.ZodType<
...
/** @internal */
export type SuggestOperationIDsResponse$Outbound = {
    HttpMeta: components.HTTPMetadata$Outbound;
    SuggestedOperationIDs?: components.SuggestedOperationIDs$Outbound | undefined;
};

/** @internal */
export const SuggestOperationIDsResponse$outboundSchema: z.ZodType<
    SuggestOperationIDsResponse$Outbound,
    z.ZodTypeDef,
    SuggestOperationIDsResponse
> = z
    .object({
...
export namespace SuggestOperationIDsResponse$ {
    /** @deprecated use `SuggestOperationIDsResponse$inboundSchema` instead. */
    export const inboundSchema = SuggestOperationIDsResponse$inboundSchema;
    /** @deprecated use `SuggestOperationIDsResponse$outboundSchema` instead. */
    export const outboundSchema = SuggestOperationIDsResponse$outboundSchema;
    /** @deprecated use `SuggestOperationIDsResponse$Outbound` instead. */
    export type Outbound = SuggestOperationIDsResponse$Outbound;
}
