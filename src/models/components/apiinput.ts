...
/** @internal */
export const ApiInput$inboundSchema: z.ZodType<ApiInput, z.ZodTypeDef, unknown> = z
    .object({
        api_id: z.string(),
...
/** @internal */
export const ApiInput$outboundSchema: z.ZodType<ApiInput$Outbound, z.ZodTypeDef, ApiInput> = z
    .object({
        apiId: z.string(),
        description: z.string(),
