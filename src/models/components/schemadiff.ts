...
/** @internal */
export const ValueChange$inboundSchema: z.ZodType<ValueChange, z.ZodTypeDef, unknown> = z
    .object({
        From: z.string(),
        To: z.string(),
    })
...
/** @internal */
export const SchemaDiff$inboundSchema: z.ZodType<SchemaDiff, z.ZodTypeDef, unknown> = z.object({
...
/** @internal */
export const SchemaDiff$outboundSchema: z.ZodType<SchemaDiff$Outbound, z.ZodTypeDef, SchemaDiff> =
    z.object({
        additions: z.array(z.string()),
        deletions: z.array(z.string()),
