...
/** @internal */
export const Manifest$inboundSchema: z.ZodType<Manifest, z.ZodTypeDef, unknown> = z.object({
...
/** @internal */
export const Manifest$outboundSchema: z.ZodType<Manifest$Outbound, z.ZodTypeDef, Manifest> =
    z.object({
        schemaVersion: z.number().int().optional(),
        mediaType: z.string().optional(),
        artifactType: z.string().optional(),
