...
import { InteractionType, InteractionType$ } from "./interactiontype.js";
...
export namespace GenerateBumpType$ {
    export const inboundSchema: z.ZodNativeEnum<typeof GenerateBumpType> =
        z.nativeEnum(GenerateBumpType);
    export const outboundSchema: z.ZodNativeEnum<typeof GenerateBumpType> = inboundSchema;
}

/** @internal */
export namespace OpenapiDiffBumpType$ {
    export const inboundSchema: z.ZodNativeEnum<typeof OpenapiDiffBumpType> =
        z.nativeEnum(OpenapiDiffBumpType);
    export const outboundSchema: z.ZodNativeEnum<typeof OpenapiDiffBumpType> = inboundSchema;
}

/** @internal */
export namespace CliEvent$ {
    export const inboundSchema: z.ZodType<CliEvent, z.ZodTypeDef, unknown> = z
        .object({
            id: z.string(),
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, CliEvent> = z
        .object({
            id: z.string(),
