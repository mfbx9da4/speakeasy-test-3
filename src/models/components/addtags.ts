...
/** @internal */
export const AddTags$inboundSchema: z.ZodType<AddTags, z.ZodTypeDef, unknown> = z
    .object({
...
/** @internal */
export const AddTags$outboundSchema: z.ZodType<AddTags$Outbound, z.ZodTypeDef, AddTags> = z
    .object({
