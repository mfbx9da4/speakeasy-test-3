...
/** @internal */
export const EmbedToken$inboundSchema: z.ZodType<EmbedToken, z.ZodTypeDef, unknown> = z
    .object({
        created_at: z
            .string()
...
/** @internal */
export const EmbedToken$outboundSchema: z.ZodType<EmbedToken$Outbound, z.ZodTypeDef, EmbedToken> = z
    .object({
