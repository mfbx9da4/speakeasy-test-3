...
export class Events extends ClientSDK {
    ...
    async postWorkspaceEvents(
        ...
        return unwrapAsync(eventsPostWorkspaceEvents(this, requestBody, workspaceID, options));
    }
    ...
    async getWorkspaceEventsByTarget(
        ...
        return unwrapAsync(
            eventsGetWorkspaceEventsByTarget(this, targetID, workspaceID, afterCreatedAt, options)
        );
    }
    ...
    async getWorkspaceTargets(
        ...
        return unwrapAsync(
            eventsGetWorkspaceTargets(this, workspaceID, afterLastEventCreatedAt, options)
        );
    }
}
