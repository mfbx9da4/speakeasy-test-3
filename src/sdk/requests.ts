...
export class Requests extends ClientSDK {
    ...
    async queryEventLog(
        ...
        return unwrapAsync(requestsQueryEventLog(this, filters, options));
    }
    ...
    async getRequestFromEventLog(
        ...
        return unwrapAsync(requestsGetRequestFromEventLog(this, requestID, options));
    }
    ...
    async generateRequestPostmanCollection(
        ...
        return unwrapAsync(requestsGenerateRequestPostmanCollection(this, requestID, options));
    }
}
