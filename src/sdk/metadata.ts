...
export class Metadata extends ClientSDK {
    ...
    async getVersionMetadata(
        ...
        return unwrapAsync(metadataGetVersionMetadata(this, apiID, versionID, options));
    }
    ...
    async insertVersionMetadata(
        ...
        return unwrapAsync(
            metadataInsertVersionMetadata(this, apiID, versionID, versionMetadata, options)
        );
    }
    ...
    async deleteVersionMetadata(
        ...
        return unwrapAsync(
            metadataDeleteVersionMetadata(this, apiID, versionID, metaKey, metaValue, options)
        );
    }
}
