...
export class Organizations extends ClientSDK {
    ...
    async getOrganizations(options?: RequestOptions): Promise<operations.GetOrganizationsResponse> {
        return unwrapAsync(organizationsGetOrganizations(this, options));
    }
    ...
    async getOrganization(
        ...
        return unwrapAsync(organizationsGetOrganization(this, organizationID, options));
    }
    ...
    async createFreeTrial(options?: RequestOptions): Promise<operations.CreateFreeTrialResponse> {
        return unwrapAsync(organizationsCreateFreeTrial(this, options));
    }
    ...
    async getOrganizationUsage(
        ...
        return unwrapAsync(organizationsGetOrganizationUsage(this, options));
    }
}
