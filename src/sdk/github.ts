...
export class Github extends ClientSDK {
    async checkAccess(
        ...
        return unwrapAsync(githubCheckAccess(this, org, repo, options));
    }
    ...
    async fetchPublishingPRs(
        ...
        return unwrapAsync(githubFetchPublishingPRs(this, generateGenLockId, org, repo, options));
    }
    ...
    async githubCheckPublishingSecrets(
        ...
        return unwrapAsync(githubGithubCheckPublishingSecrets(this, generateGenLockId, options));
    }
    ...
    async getAction(
        ...
        return unwrapAsync(githubGetAction(this, org, repo, targetName, options));
    }
}
