...
export class ApiEndpoints extends ClientSDK {
    ...
    async getAllApiEndpoints(
        ...
        return unwrapAsync(apiEndpointsGetAllApiEndpoints(this, apiID, options));
    }
    ...
    async getAllForVersionApiEndpoints(
        ...
        return unwrapAsync(
            apiEndpointsGetAllForVersionApiEndpoints(this, apiID, versionID, options)
        );
    }
    ...
    async findApiEndpoint(
        ...
        return unwrapAsync(
            apiEndpointsFindApiEndpoint(this, apiID, versionID, displayName, options)
        );
    }
    ...
    async deleteApiEndpoint(
        ...
        return unwrapAsync(
            apiEndpointsDeleteApiEndpoint(this, apiID, versionID, apiEndpointID, options)
        );
    }
    ...
    async getApiEndpoint(
        ...
        return unwrapAsync(
            apiEndpointsGetApiEndpoint(this, apiID, versionID, apiEndpointID, options)
        );
    }
    ...
    async generateOpenApiSpecForApiEndpoint(
        ...
        return unwrapAsync(
            apiEndpointsGenerateOpenApiSpecForApiEndpoint(
                this,
                apiID,
                versionID,
                apiEndpointID,
