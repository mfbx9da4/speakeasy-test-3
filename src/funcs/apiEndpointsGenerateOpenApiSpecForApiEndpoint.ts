...
> {
    ...
    const [result$] = await m$.match<
        ...
        | ConnectionError
    >(
        m$.json(200, operations.GenerateOpenApiSpecForApiEndpointResponse$inboundSchema, {
            key: "GenerateOpenApiSpecDiff",
        }),
        m$.fail(["4XX", "5XX"]),
        m$.json("default", operations.GenerateOpenApiSpecForApiEndpointResponse$inboundSchema, {
            key: "Error",
        })
