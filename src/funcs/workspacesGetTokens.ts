 ...
 */
export async function workspacesGetTokens(
  client: SDKCore,
  workspaceId: string,
  ...
  >
> {
  const input: operations.GetWorkspaceTokensRequest = {
    workspaceId: workspaceId,
  };

  const parsed = safeParse(
    input,
    (value) => operations.GetWorkspaceTokensRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json("2XX", operations.GetWorkspaceTokensResponse$inboundSchema, {
      key: "WorkspaceTokens",
    }),
