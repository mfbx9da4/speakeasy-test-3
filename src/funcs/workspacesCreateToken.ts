 ...
 */
export function workspacesCreateToken(
  client: SDKCore,
...
> {
  const input: operations.CreateWorkspaceTokenRequest = {
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.nil("2XX", operations.CreateWorkspaceTokenResponse$inboundSchema),
