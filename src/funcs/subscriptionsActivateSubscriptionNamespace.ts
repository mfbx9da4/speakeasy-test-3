 ...
 */
export function subscriptionsActivateSubscriptionNamespace(
  client: SDKCore,
...
> {
  const input: operations.ActivateSubscriptionNamespaceRequest = {
  ...
  const parsed = safeParse(
    input,
    (value) =>
      operations.ActivateSubscriptionNamespaceRequest$outboundSchema.parse(
        value,
      ),
  ...
  >(
    M.nil(
      "2XX",
      operations.ActivateSubscriptionNamespaceResponse$inboundSchema,
    ),
