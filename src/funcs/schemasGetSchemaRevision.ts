...
> {
  ...
  const parsed$ = schemas$.safeParse(
    input$,
    (value$) =>
      operations.GetSchemaRevisionRequest$outboundSchema.parse(value$),
  ...
  const [result$] = await m$.match<
    ...
    | ConnectionError
  >(
    m$.json(200, operations.GetSchemaRevisionResponse$inboundSchema, {
      key: "Schema",
    }),
    m$.fail(["4XX", "5XX"]),
    m$.json("default", operations.GetSchemaRevisionResponse$inboundSchema, {
      key: "Error",
    }),
