...
> {
    ...
    const path$ = pathToFunc("/v1/suggest/operation_ids/{namespace_name}/{revision_reference}")(
        pathParams$
    );
    ...
    const [result$] = await m$.match<
        ...
        | ConnectionError
    >(
        m$.json(200, operations.SuggestOperationIDsRegistryResponse$inboundSchema, {
