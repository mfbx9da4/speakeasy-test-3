...
> {
    ...
    const [result$] = await m$.match<
        ...
        | ConnectionError
    >(
        m$.json(200, operations.GetAllApiEndpointsResponse$inboundSchema, { key: "ApiEndpoints" }),
        m$.fail(["4XX", "5XX"]),
        m$.json("default", operations.GetAllApiEndpointsResponse$inboundSchema, { key: "Error" })
