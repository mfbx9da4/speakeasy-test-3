 ...
 */
export function artifactsSetVisibility(
  client: SDKCore,
...
> {
  const input: operations.SetVisibilityRequest = {
  ...
  const parsed = safeParse(
    input,
    (value) => operations.SetVisibilityRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.nil("2XX", operations.SetVisibilityResponse$inboundSchema),
