...
> {
    ...
    const parsed$ = schemas$.safeParse(
        input$,
        (value$) =>
            operations.GeneratePostmanCollectionForApiEndpointRequest$outboundSchema.parse(value$),
    ...
    const [result$] = await m$.match<
        ...
        | ConnectionError
    >(
        m$.stream(200, operations.GeneratePostmanCollectionForApiEndpointResponse$inboundSchema, {
