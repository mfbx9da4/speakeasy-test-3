...
> {
    ...
    const path$ = pathToFunc("/v1/apis/{apiID}/version/{versionID}/schema/download")(pathParams$);
    ...
    >(
        ...
        m$.fail(["4XX", "5XX"]),
        m$.json("default", operations.DownloadSchemaResponse$inboundSchema, { key: "Error" })
