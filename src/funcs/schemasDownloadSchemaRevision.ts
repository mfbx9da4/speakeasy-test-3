...
> {
  ...
  const parsed = safeParse(
    input,
    (value) =>
      operations.DownloadSchemaRevisionRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.stream("2XX", operations.DownloadSchemaRevisionResponse$inboundSchema, {
      ctype: "application/json",
      key: "2XX_application/json_Schema",
    }),
    M.stream("2XX", operations.DownloadSchemaRevisionResponse$inboundSchema, {
      ctype: "application/x-yaml",
      key: "2XX_application/x-yaml_Schema",
    }),
