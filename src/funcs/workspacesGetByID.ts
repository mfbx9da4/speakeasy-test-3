 ...
 */
export async function workspacesGetByID(
  client: SDKCore,
  workspaceId: string,
...
> {
  ...
  const path = pathToFunc("/v1/workspace/{workspace_id}")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json("2XX", operations.GetWorkspaceResponse$inboundSchema, {
      key: "Workspace",
    }),
