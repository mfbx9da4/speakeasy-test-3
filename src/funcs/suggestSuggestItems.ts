 ...
 */
export function suggestSuggestItems(
  client: SDKCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => components.SuggestItemsRequestBody$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v1/suggest/items")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json("2XX", operations.SuggestItemsResponse$inboundSchema, {
      key: "strings",
    }),
    M.fail("4XX"),
    M.fail("5XX"),
