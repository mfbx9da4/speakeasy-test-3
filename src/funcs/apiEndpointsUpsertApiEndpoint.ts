 ...
 */
export async function apiEndpointsUpsertApiEndpoint(
    client$: SDKCore,
    apiID: string,
    versionID: string,
...
> {
    ...
    const path$ = pathToFunc("/v1/apis/{apiID}/version/{versionID}/api_endpoints/{apiEndpointID}")(
        pathParams$
    );
    ...
    const [result$] = await m$.match<
        ...
        | ConnectionError
    >(
        m$.json(200, operations.UpsertApiEndpointResponse$inboundSchema, { key: "ApiEndpoint" }),
        m$.fail(["4XX", "5XX"]),
        m$.json("default", operations.UpsertApiEndpointResponse$inboundSchema, { key: "Error" })
