...
> {
  ...
  const parsed$ = schemas$.safeParse(
    input$,
    (value$) =>
      operations.UpsertApiEndpointRequest$outboundSchema.parse(value$),
  ...
  const [result$] = await m$.match<
    ...
    | ConnectionError
  >(
    m$.json(200, operations.UpsertApiEndpointResponse$inboundSchema, {
      key: "ApiEndpoint",
    }),
    m$.fail(["4XX", "5XX"]),
    m$.json("default", operations.UpsertApiEndpointResponse$inboundSchema, {
      key: "Error",
    }),
