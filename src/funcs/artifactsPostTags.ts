 ...
 */
export async function artifactsPostTags(
    client$: SDKCore,
...
> {
    ...
    const path$ = pathToFunc("/v1/artifacts/namespaces/{namespace_name}/tags")(pathParams$);
    ...
    const [result$] = await m$.match<
        ...
        | ConnectionError
    >(
        m$.nil(200, operations.PostTagsResponse$inboundSchema),
        m$.fail(["4XX", "5XX"]),
        m$.json("default", operations.PostTagsResponse$inboundSchema, { key: "Error" })
