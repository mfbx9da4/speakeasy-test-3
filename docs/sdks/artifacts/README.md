...
```typescript
import { SDKCore } from "petstore/core.js";
import { artifactsGetOASSummary } from "petstore/funcs/artifactsGetOASSummary.js";
...
async function run() {
  const res = await artifactsGetOASSummary(sdk, "<value>", "<value>");
...
**Promise\<[operations.GetOASSummaryResponse](../../models/operations/getoassummaryresponse.md)\>**
