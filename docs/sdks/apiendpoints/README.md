...
async function run() {
  const res = await apiEndpointsGetAllApiEndpoints(sdk, "<value>");
...
async function run() {
  const res = await apiEndpointsGetAllForVersionApiEndpoints(sdk, "<value>", "<value>");
...
async function run() {
  const res = await apiEndpointsFindApiEndpoint(sdk, "<value>", "<value>", "Don.Strosin");
...
async function run() {
  const res = await apiEndpointsDeleteApiEndpoint(sdk, "<value>", "<value>", "<value>");
...
async function run() {
  const res = await apiEndpointsGetApiEndpoint(sdk, "<value>", "<value>", "<value>");
...
async function run() {
  const res = await apiEndpointsUpsertApiEndpoint(sdk, "<value>", "<value>", "<value>", {
    apiEndpointId: "<value>",
    description: "Public-key systematic attitude",
    displayName: "Camille.Schaefer11",
    method: "<value>",
...
async function run() {
  const res = await apiEndpointsGenerateOpenApiSpecForApiEndpoint(sdk, "<value>", "<value>", "<value>");
...
async function run() {
  const res = await apiEndpointsGeneratePostmanCollectionForApiEndpoint(sdk, "<value>", "<value>", "<value>");
