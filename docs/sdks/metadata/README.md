...
async function run() {
  const res = await metadataGetVersionMetadata(sdk, "<id>", "<id>");
...
async function run() {
  const res = await metadataInsertVersionMetadata(sdk, {
    metaKey: "<value>",
    metaValue: "<value>",
  }, "<id>", "<id>");
...
async function run() {
  const res = await metadataDeleteVersionMetadata(sdk, "<id>", "<id>", "<value>", "<value>");
