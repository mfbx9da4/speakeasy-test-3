...
```typescript
import { SDKCore } from "petstore/core.js";
import { githubFetchPublishingPRs } from "petstore/funcs/githubFetchPublishingPRs.js";
...
async function run() {
  const res = await githubFetchPublishingPRs(sdk, "<value>", "<value>", "<value>");
...
```typescript
import { SDKCore } from "petstore/core.js";
import { githubGithubCheckPublishingSecrets } from "petstore/funcs/githubGithubCheckPublishingSecrets.js";
...
async function run() {
  const res = await githubGithubCheckPublishingSecrets(sdk, "<value>");
...
```typescript
import { SDKCore } from "petstore/core.js";
import { githubGithubStorePublishingSecrets } from "petstore/funcs/githubGithubStorePublishingSecrets.js";
...
async function run() {
  const res = await githubGithubStorePublishingSecrets(sdk, {
    generateGenLockId: "<value>",
  });
