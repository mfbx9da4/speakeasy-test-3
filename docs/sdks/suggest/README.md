...
async function run() {
  const result = await sdk.suggest.suggestItems({
    prompt: "<value>",
    items: [
...
```typescript
import { SDKCore } from "petstore/core.js";
import { suggestSuggestItems } from "petstore/funcs/suggestSuggestItems.js";
...
async function run() {
  const res = await suggestSuggestItems(sdk, {
    prompt: "<value>",
    items: [
...
**Promise\<[operations.SuggestItemsResponse](../../models/operations/suggestitemsresponse.md)\>**
