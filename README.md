...
- [suggestSuggestOpenAPIRegistry](docs/sdks/suggest/README.md#suggestopenapiregistry)
- [suggestSuggestOpenAPI](docs/sdks/suggest/README.md#suggestopenapi)
- [suggestSuggest](docs/sdks/suggest/README.md#suggest)
- [workspacesGetWorkspaceFeatureFlags](docs/sdks/workspaces/README.md#getworkspacefeatureflags)
...
async function run() {
  let result;
  try {
    result = await sdk.workspaces.getWorkspaceFeatureFlags();
